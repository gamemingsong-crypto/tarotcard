...
def build_set2_embed(has_attached_gif: bool = False) -> discord.Embed:
    ...
    embed.add_field(
        ...
        value=(
            ...
            "**ดูดวง** = เลือกช่วงเวลา: รายวัน/รายเดือน + หมวดหมู่: ภาพรวม, การเงิน, การงาน, ความรัก, สุขภาพ\n"
            "**เปิดไพ่** = เลือกจำนวนไพ่ 1, 3, 5, หรือ 10 ใบ พร้อมคำทำนายตามตำแหน่งและทิศทางไพ่\n"
        ),
        inline=False,
    )
